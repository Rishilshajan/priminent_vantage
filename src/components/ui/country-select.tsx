    ...
    return (
        <div className="relative w-full" ref={wrapperRef}>
            <div
                ...
                className={cn(
                    "flex h-12 w-full items-center justify-between rounded-lg border border-input bg-background px-4 py-2 text-sm ring-offset-background cursor-pointer",
            ...
            {isOpen && (
                <div className="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md border border-input bg-background py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="sticky top-0 bg-background px-2 py-1.5 border-b z-10">
                        <input
                            type="text"
                    ...
                    {filteredCountries.length === 0 ? (
                        <div className="px-2 py-2 text-sm text-muted-foreground text-center">No country found</div>
                    ) : (
                        <ul>
                            {filteredCountries.map((country) => (
                                <li
                                    ...
                                    className={cn(
                                        ...
                                        value === country.name && "bg-accent/50 text-accent-foreground"
                                    )}
                                >
                                    <div className="flex items-center gap-2">
                                        <img
                                    ...
                                    {value === country.name && <Check className="h-4 w-4 text-primary" />}
                                </li>
                            ))}
                        </ul>
                    )}
