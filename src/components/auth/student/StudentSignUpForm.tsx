...
import { studentSignup as signup } from "@/actions/auth/student.auth";
    ...
    return (
        <div className="order-1 lg:order-2">
            <div className="bg-card p-8 md:p-10 rounded-3xl shadow-2xl border border-border/50 max-w-md mx-auto w-full relative">
                ...
                <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-primary via-indigo-500 to-purple-500 rounded-t-3xl"></div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="flex items-start gap-2 pt-1">
                        ...
                        <div className="grid gap-1.5 leading-none">
                            ...
                            >
                                By creating an account, I agree to the <Link href="/terms" className="text-primary hover:underline font-medium">Terms of Service</Link> and <Link href="/privacy" className="text-primary hover:underline font-medium">Privacy Policy</Link>.
                            </label>
                            {errors.terms && (
