...
export function StudentLoginForm() {
    ...
    return (
        <div className="order-1 lg:order-2">
            <div className="bg-card p-8 rounded-2xl shadow-xl border border-border max-w-md mx-auto w-full">
                ...
                <Button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white dark:bg-slate-700 text-slate-700 dark:text-white border border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-600 font-medium py-2.5 rounded-lg transition-colors mb-6 h-12"
                >
                ...
                <div className="relative flex py-2 items-center mb-6">
                    ...
                    <span className="flex-shrink-0 mx-4 text-xs font-bold text-muted-foreground uppercase">Or log in with email</span>
                    <div className="flex-grow border-t border-border"></div>
                </div>

                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        <Label htmlFor="email" className="mb-1 block">Email or username</Label>
                        <Input
                            id="email"
                            type="email"
                    ...
                    <Button
                        type="submit"
                        className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5 mt-2 h-12"
