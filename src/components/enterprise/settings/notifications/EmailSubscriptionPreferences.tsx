...
interface EmailSubscriptionPreferencesProps {
    weeklySummary: boolean;
    newEnrollment: boolean;
    completionAlert: boolean;
    onWeeklySummaryChange: (val: boolean) => void;
    onNewEnrollmentChange: (val: boolean) => void;
    onCompletionAlertChange: (val: boolean) => void;
}
...
export default function EmailSubscriptionPreferences({
    ...
    onNewEnrollmentChange,
    onCompletionAlertChange
}: EmailSubscriptionPreferencesProps) {
    return (
        <section className="bg-white dark:bg-[#1f1629] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                <div className="p-6 flex items-center justify-between gap-8">
                    ...
                    <Switch
                        checked={newEnrollment}
                        onCheckedChange={onNewEnrollmentChange}
                    />
                </div>
                <div className="p-6 flex items-center justify-between gap-8">
                    <div className="flex-1">
                    ...
                    <Switch
                        ...
                        onCheckedChange={onCompletionAlertChange}
                    />
                </div>
            </div>
        </section>
