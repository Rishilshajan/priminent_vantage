...
interface GDPRComplianceProps {
    gdprMode: boolean;
    onGdprModeChange: (checked: boolean) => void;
    rtbfAutomation: boolean;
    onRtbfAutomationChange: (checked: boolean) => void;
    disabled?: boolean;
}
        ...
        <section className="bg-white dark:bg-[#1f1629] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
                ...
                <div className="p-6 flex items-center justify-between gap-8">
                    ...
                    <Switch
                        checked={rtbfAutomation}
                        onCheckedChange={onRtbfAutomationChange}
                        disabled={disabled}
                    />
                </div>
            </div>
